...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        ...
        registry.addEndpoint("/studioSession").setAllowedOrigins("http://localhost:3000/", "https://tryopenbeats.com/", "https://www.tryopenbeats.com/").withSockJS();
       //registry.addEndpoint("/studioSession").setAllowedOrigins("https://d1f1mof8sp9w8z.cloudfront.net/").withSockJS();
    }
